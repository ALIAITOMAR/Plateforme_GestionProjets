							...
							<div class="p-1.5 min-w-full inline-block align-middle">
							  <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
								...
								<div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
								  ...
								  <div>
									<div class="inline-flex gap-x-2">
									  <a href="{{ route('enseignant.apprenants') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800" href="#">
										View all
									  </a>
									</div>
								  </div>
								...
								<tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
									@forelse ($topApprenants as $apprenant)
									<tr>
									...
									<td class="size-px whitespace-nowrap">
										<div class="px-6 py-3">	
											<div class="flex justify-center text-center -space-x-4 rtl:space-x-reverse">
													@foreach ($apprenant->classe->apprenants->take(4) as $apprenant)
													...
													@endforeach
													@if ($apprenant->classe->apprenants->count() > 4)
														<a class="flex items-center justify-center w-10 h-10 text-xs font-medium text-white bg-gray-700 border-2 border-white rounded-full hover:bg-gray-600 dark:border-gray-800" href="#">+{{ ($apprenant->classe->apprenants->count() - 4) }}</a>
													@elseif ($apprenant->classe->apprenants->count() === 0)
														{{ $apprenant->classe->apprenants->count() }}
													@endif
												</div>
											</div>
										</div>
									...
									<td class="size-px whitespace-nowrap">
										<div class="px-6 py-3">
										<span class="text-sm text-gray-500 dark:text-neutral-500">{{ $apprenant->created_at->format('d M, Y') }}</span>
										</div>
									</td>
